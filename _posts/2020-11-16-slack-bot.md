...
before you turn off notification for most of the channels you
...
The app does not work without a `users` and `subscriptions` tables. We thus need a
...
This migration checks if the required tables exists, and if it is missing, it creates them.
...
Go to your workspace and add the Stalker bot to your Apps. Test it out and subscribe to your
favorite person in a busy channel full of noise. Each time the stalked person writes
you will get a direct message to notify you.
